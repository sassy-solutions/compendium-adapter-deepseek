// -----------------------------------------------------------------------
// <copyright file="DeepseekAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.Deepseek;

/// <summary>
/// Deepseek adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class DeepseekAdapter
{
    private readonly DeepseekOptions _options;
    private readonly ILogger<DeepseekAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="DeepseekAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public DeepseekAdapter(IOptions<DeepseekOptions> options, ILogger<DeepseekAdapter> logger)
    {
